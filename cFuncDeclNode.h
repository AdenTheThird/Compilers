...
{
public:
    cFuncDeclNode(cSymbol* type, cSymbol* name, cParamsNode* params, bool hasBody)
        : m_type(type), m_name(name), m_params(params), m_decls(nullptr), m_stmts(nullptr), m_hasBody(hasBody)
    {
    ...
    cFuncDeclNode(cSymbol* type, cSymbol* name, cParamsNode* params, cStmtsNode* stmts, bool hasBody)
        : m_type(type), m_name(name), m_params(params), m_decls(nullptr), m_stmts(stmts), m_hasBody(hasBody)
    {
        cSymbol* existing = g_symbolTable.FindLocal(name->GetName());
        if (existing)
        {
    ...
    cFuncDeclNode(cSymbol* type, cSymbol* name, cParamsNode* params, cDeclsNode* decls, cStmtsNode* stmts, bool hasBody)
        : m_type(type), m_name(name), m_params(params), m_decls(decls), m_stmts(stmts), m_hasBody(hasBody)
    {
        cSymbol* existing = g_symbolTable.FindLocal(name->GetName());
        if (existing)
        {
